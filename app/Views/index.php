...
<body id="page-top" class="politics_version">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('uploads/Banner Ruzi.jpg')">
		<div class="heading">
			<h1>hello Ruzi Yandi</h1>
			<p>"Lampung Pesawaran, <br></p>
			<h3 class="cd-headline clip is-full-width">
				<span class="cd-words-wrapper">
					<b class="is-visible">Web Framework</b>
				</span>
			</h3>
		</div>
	</section>
	...
	<div id="portfolio" class="section lb">
		<div class="container">
			<div class="section-title text-left">
                <h3>Portfolio</h3>
                <p>"Halo! Saya Ruzi Yandi seorang mahasiswa. Saya memiliki hasrat besar untuk menciptakan visual yang tidak hanya estetis tetapi juga fungsional dan strategis,
				Selain itu, saya senang belajar hal-hal baru dan terus mengikuti tren terkini di industri desain untuk memastikan bahwa pekerjaan saya selalu relevan dan inovatif. Jika Anda mencari seorang desainer yang dapat membantu mewujudkan visi kreatif".
				</p>
            </div><!-- end title -->
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    ...
                    <p class="footer-company-name">All Rights Reserved. &copy; 2025 <a href="#">Ruzi</a> Design By : 
					<a href="https://html.design/">web framework</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
